...
INTERFACE zif_adcoset_ty_global
  ...
  TYPES ty_std_tr_request_objects TYPE TABLE OF ty_tr_request_object.
  TYPES:
    BEGIN OF ty_object,
      name TYPE sobj_name,
      type TYPE wbobjtype,
  ...
  TYPES ty_patterns TYPE STANDARD TABLE OF ty_pattern WITH EMPTY KEY.
  TYPES:
  ...
  TYPES ty_search_option_ranges TYPE STANDARD TABLE OF ty_search_option_range WITH EMPTY KEY.
  TYPES:
  ...
  TYPES ty_search_options TYPE STANDARD TABLE OF ty_search_option WITH KEY option.
ENDINTERFACE.

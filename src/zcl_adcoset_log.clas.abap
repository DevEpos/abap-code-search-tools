"! <p class="shorttext synchronized" lang="en">Messages that occur during processing</p>
CLASS zcl_adcoset_log DEFINITION
  ...
  PUBLIC SECTION.
    CLASS-METHODS:
      ...
      "! <p class="shorttext synchronized" lang="en">Adds message</p>
      add_message
        IMPORTING
          type    TYPE string
          content TYPE string,
      "! <p class="shorttext synchronized" lang="en">Adds a list of messages</p>
      add_all_messages
        IMPORTING
          messages TYPE zif_adcoset_ty_global=>ty_messages,
      "! <p class="shorttext synchronized" lang="en">Clears current list of messages</p>
      clear,
      "! <p class="shorttext synchronized" lang="en">Returns current list of messages</p>
      get_messages
        RETURNING
  ...
  PRIVATE SECTION.
    CLASS-DATA:
      messages TYPE HASHED TABLE OF zif_adcoset_ty_global=>ty_message WITH UNIQUE KEY content.
ENDCLASS.
...
CLASS zcl_adcoset_log IMPLEMENTATION.
  ...
  METHOD add_exception.
    ...
    add_message(
      type    = zif_adcoset_c_global=>c_message_type-error
